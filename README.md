...
- [2025.2.13] 提交代码：XTuner环境配置、FT配置文件；处理SFT微调数据脚本；微调说明文档。

- [2025.2.13] 更新ASR代码和最终选型信息。

- [2025.1.6] 提交代码：添加LightRAG-Ollama实现代码。

- [2025.1.3] 提交代码：更新实现RAG-LightRAG知识库，通过硅基云处理；添加ASR-Funasr初版代码。

- [2024.12.26] 更新README.md，更新最新架构图。

- [2024.12.24] 提交代码：处理不同类型（PDF、Excel、Csv、Doc、Markdown）数据格式，实现RAG功能。

- [2024.12.24] 提交代码：获取并处理财报、新闻资讯、舆情变动、基础行情数据。

- [2024.12.24] 添加README.md。
